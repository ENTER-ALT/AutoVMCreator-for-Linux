...
def main():
    ...
    medium_attachment_hdd = Creator.create_attachment_config(storage_controller1, hdd_medium, DriveType.HDD)
    ...
    medium_attachment_iso = Creator.create_attachment_config(storage_controller1, iso_medium, DriveType.DVD_DRIVE)
